...
//   NormalUser: 'normalUser',     // کاربر معمولی - Type 1
//   MemberUser: 'memberUser',     // کاربر عضو - Type 2
//   Marketer: 'marketer',         // بازاریاب - Type 3
//   EstateAgent: 'estateAgent',   // بنگاه املاک - Type 4
//   SuperAdmin: 'superAdmin',     // سوپر ادمین - Admin Type 1
//   Admin: 'admin',               // ادمین - Admin Type 2
//   SubscriberUser: 'subscriber', // کاربر اشتراکی - Admin Type 3
// }

// export type UserRoleType =
//   | 'normalUser'     // Type 1 - کاربر معمولی
//   | 'memberUser'     // Type 2 - کاربر عضو
//   | 'marketer'       // Type 3 - بازاریاب
//   | 'estateAgent'    // Type 4 - بنگاه املاک
//   | 'superAdmin'     // Admin Type 1 - سوپر ادمین
//   | 'admin'          // Admin Type 2 - ادمین
//   | 'subscriber'     // Admin Type 3 - کاربر اشتراکی
...
export const NEXT_PUBLIC_API_URL = 'http://193.151.129.243:4000'
