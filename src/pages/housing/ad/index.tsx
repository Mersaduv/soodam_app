    ...
    <ClientLayout title="ثبت آگهی">
      <div className="pt-[90px] pb-[90px] px-4">
        <div className="space-y-4">
          ...
          >
            <span className='bg-[#E0FBF5] text-[#17A586] w-[52px] h-[21px] font-normal text-[11px] flex-center rounded-[59px] absolute top-4 left-4'>رایگان</span>
          ...
          >
            <Image src="/static/megaphone-voice-being-heard (1).png" alt="ثبت آگهی" layout="intrinsic" width={171} height={171} />
