          ...
          <div className="space-y-4">
            ...
            >
              <div className="w-[200px] max-w-[160px] space-y-2 flex flex-col justify-between h-full">
                ...
                <p className="text-[13px] font-normal text-[#5A5A5A]"> برای استفاده از شماره تماس و 
آدرس دقیق آگهی ها نیاز به خرید
اشتراک دارید.</p>
            ...
            >
              <div className="w-[200px] max-w-[160px] space-y-2 flex flex-col justify-between h-full">
              <p className="text-[15px] font-normal">کاربر عضو عزیز:               </p>
                <p className="text-[13px] font-normal text-[#5A5A5A]">شما می توانید به عنوان بازاریاب
                فعالیت کنید و با ثبت آگهی های ملک درآمد کسب کنید.</p>
                <button className="text-white bg-[#D52133] w-full text-xs h-[24px] rounded-lg mt-2">
                ثبت نام بازاریاب
                </button>
              </div>
